...
<div class="flex flex-col lg:flex-row gap-6">
  <div id="trailer-col" class="w-full lg:w-[480px] shrink-0 lg:sticky lg:top-4 lg:self-start">
    <div class="lg:sticky lg:top-4 z-10">
      ...
      <div id="trailer-video" class="relative w-full max-h-[200px] lg:max-h-[270px] overflow-hidden rounded-2xl" style="padding-bottom:56.25%">
