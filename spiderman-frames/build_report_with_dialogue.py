  ...
  <div id="trailer-col" class="w-full lg:w-[480px] shrink-0">
    <div class="sticky top-4 z-10">
      <div class="flex gap-2 mb-2">
        <button id="toggle-trailer-btn" onclick="var v=document.getElementById('trailer-video'),b=document.getElementById('toggle-trailer-btn');v.classList.toggle('hidden');b.innerHTML=v.classList.contains('hidden')?'<svg class=\"w-4 h-4 inline-block align-text-bottom\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z\"/><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M21 12a9 9 0 11-18 0 9 9 0 0118 0z\"/></svg> Show':'<svg class=\"w-4 h-4 inline-block align-text-bottom\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z\"/></svg> Hide';" class="text-xs text-gray-400 bg-white/5 hover:bg-white/10 px-3 py-1.5 rounded-full flex-1 transition"><svg class="w-4 h-4 inline-block align-text-bottom" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg> Hide</button>
      </div>
